...
const baseUrl =
  "https://assetsperception.s3.ap-south-1.amazonaws.com/assets/spatial";

const flashImage = [
  "/level1/objects/SR+TR+S.png",
  "/level1/shapes/SR+TR+S.png",
  "/level2/objects/SR+L1+S.png",
  "/level2/shapes/SR+L1+S.png",
  "/level3/objects/SR+L2+S.png",
  "/level3/shapes/SR+L2+S.png",
  "/level4/objects/SR+L3+S.png",
  "/level4/shapes/SR+L3+S.png",
  "/level5/objects/SR+L4+S.png",
  "/level5/shapes/SR+L4+S.png",
  "/level6/objects/SR+L5+S.png",
  "/level6/shapes/SR+L5+S.png",
];

const correctImage = [
  "/level1/objects/SR+TR+CR.png",
  "/level1/shapes/SR+TR+CR.png",
  "/level2/objects/SR+L1+CR.png",
  "/level2/shapes/SR+L1+CR.png",
  "/level3/objects/SR+L2+CR.png",
  "/level3/shapes/SR+L2+CR.png",
  "/level4/objects/SR+L3+CR.png",
  "/level4/shapes/SR+L3+CR.png",
  "/level5/objects/SR+L4+CR.png",
  "/level5/shapes/SR+L4+CR.png",
  "/level6/objects/SR+L5+CR.png",
  "/level6/shapes/SR+L5+CR.png",
];
...
const inCorrectImage = [
  [
    // Level 1
    [
      "/level1/objects/SR+TR+INC+1.png",
      "/level1/objects/SR+TR+INC+2.png",
      "/level1/objects/SR+TR+INC+3.png",
    ],
    [
      "/level1/shapes/SR+TR+INC+1.png",
      "/level1/shapes/SR+TR+INC+2.png",
      "/level1/shapes/SR+TR+INC+3.png",
    ],
  ],
  [
    // Level 2
    [
      "/level2/objects/SR+L1+INC+1.png",
      "/level2/objects/SR+L1+INC+2.png",
      "/level2/objects/SR+L1+INC+3.png",
    ],
    [
      "/level2/shapes/SR+L1+INC+1.png",
      "/level2/shapes/SR+L1+INC+2.png",
      "/level2/shapes/SR+L1+INC+3.png",
    ],
  ],
  [
    // Level 3
    [
      "/level3/objects/SR+L2+INC+1.png",
      "/level3/objects/SR+L2+INC+2.png",
      "/level3/objects/SR+L2+INC+3.png",
    ],
    [
      "/level3/shapes/SR+L2+INC+1.png",
      "/level3/shapes/SR+L2+INC+2.png",
      "/level3/shapes/SR+L2+INC+3.png",
    ],
  ],
  [
    // Level 4
    [
      "/level4/objects/SR+L3+INC+1.png",
      "/level4/objects/SR+L3+INC+2.png",
      "/level4/objects/SR+L3+INC+3.png",
    ],
    [
      "/level4/shapes/SR+L3+INC+1.png",
      "/level4/shapes/SR+L3+INC+2.png",
      "/level4/shapes/SR+L3+INC+3.png",
    ],
  ],
  [
    // Level 5
    [
      "/level5/objects/SR+L4+INC+1.png",
      "/level5/objects/SR+L4+INC+2.png",
      "/level5/objects/SR+L4+INC+3.png",
    ],
    [
      "/level5/shapes/SR+L4+INC+1.png",
      "/level5/shapes/SR+L4+INC+2.png",
      "/level5/shapes/SR+L4+INC+3.png",
    ],
  ],
  [
    // Level 6
    [
      "/level6/objects/SR+L5+INC+1.png",
      "/level6/objects/SR+L5+INC+2.png",
      "/level6/objects/SR+L5+INC+3.png",
    ],
    [
      "/level6/shapes/SR+L5+INC+1.png",
      "/level6/shapes/SR+L5+INC+2.png",
      "/level6/shapes/SR+L5+INC+3.png",
    ],
  ],
];

const SpatialResolution: React.FC = () => {
  ...
  const handleClick = (id: string) => {
    ...
    if (level >= 2) {
      saveScore("sunny", "ec", level + 1 - 2, correct, durationMs);
    }
    nextLevel();
  };
...
export default SpatialResolution;

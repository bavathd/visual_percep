...
const baseUrl = "https://visualperceptiondomain.s3.ap-south-1.amazonaws.com/game-assets/egocentric"
const flashImage = ["/level1/EGO+TR+S.png",
                    "/level2/EGO+L1+S.png", 
                    "/level3/EGO+L2+S.png", 
                    "/level4/EGO+L3+S.png", 
                    "/level5/EGO+L4+S.png", 
...
const correctImage = [["/level1/EGO+TR+CR.png"],
                      ["/level2/EGO+L1+CR.png"],
                      ["/level3/EGO+L2+CR.png"], 
                      ["/level4/EGO+L3+CR.png"], 
                      ["/level5/EGO+L4+CR.png"], 
                      ["/level6/EGO+L5+CR.png"] 
                    ];

const inCorrectImage = [[
                            "/level1/EGO+TR+INC+1.png", 
                            "/level1/EGO+TR+INC+2.png",
                            "/level1/EGO+TR+INC+3.png",
                        ],
                        [
                            "/level2/EGO+L1+INC+1.png", 
                            "/level2/EGO+L1+INC+2.png",
                            "/level2/EGO+L1+INC+3.png",
                            "/level2/EGO+L1+INC+4.png",
                        ],
                        [
                            "/level3/EGO+L2+INC+1.png",
                            "/level3/EGO+L2+INC+2.png",
                            "/level3/EGO+L2+INC+3.png",
                        ], 
                        [
                            "/level4/EGO+L3+INC+1.png",
                            "/level4/EGO+L3+INC+2.png",
                            "/level4/EGO+L3+INC+3.png",
                            "/level4/EGO+L3+INC+4.png",
                        ],
                        [
                         "/level5/EGO+L4+INC+1.png",
                         "/level5/EGO+L4+INC+2.png", 
                         "/level5/EGO+L4+INC+3.png", 
                         "/level5/EGO+L4+INC+4.png", 
                         "/level5/EGO+L4+INC+5.png", 
                         "/level5/EGO+L4+INC+6.png", 
                        ],
                        [                            
                            "/level6/EGO+L5+INC+1.png",
                            "/level6/EGO+L5+INC+2.png",
                            "/level6/EGO+L5+INC+3.png",
                            "/level6/EGO+L5+INC+4.png",
                        ],
                        ];

const Egocentric:React.FC=()=>{
       ...
       return (
           ...
           <div className="flex justify-between items-center mb-4">
             ...
             <div className="text-lg font-bold text-white bg-blue-600 rounded-xl px-4 py-2">
              Egocentric Visual Spatial Relation Test
             </div>
           ...
           <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 w-full overflow-hidden relative">
               ...
               <div className="bg-white dark:bg-gray-800 text-center rounded-xl shadow-2xl p-6 w-80 mx-4 transform transition-all duration-300">
                   ...
                   EgoCentric Visual Spatial Relation Assessment
                   </h2>

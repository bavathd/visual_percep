...
const baseUrl = "https://visualperceptiondomain.s3.ap-south-1.amazonaws.com/game-assets/globalMotion"
const flashImage = ["/level1/GMP+TR+S.gif",
                    "/level2/GMP+L1+S.gif", 
                    "/level3/GMP+L2+S.gif", 
                    "/level4/GMP+L3+S.gif", 
                    "/level5/GMP+L4+S.gif", 
...
const correctImage = [["/level1/GMP+TR+CR.png"],
                      ["/level2/GMP+L1+CR.png"],
                      ["/level3/GMP+L2+CR.png"], 
                      ["/level4/GMP+L3+CR.png"], 
                      ["/level5/GMP+L4+CR.png"], 
                      ["/level6/GMP+L5+CR.png"] 
                    ];

const inCorrectImage = [[
                            "/level1/GMP+TR+INC+1.png", 
                            "/level1/GMP+TR+INC+2.png",
                           
                        ],
                        [
                            "/level2/GMP+L1+INC+1.png", 
                            "/level2/GMP+L1+INC+2.png",
                          
                        ],
                        [
                            "/level3/GMP+L2+INC+1.png",
                            "/level3/GMP+L2+INC+2.png",
                           
                        ], 
                        [
                            "/level4/GMP+L3+INC+1.png",
                            "/level4/GMP+L3+INC+2.png",
                          
                        ],
                        [
                         "/level5/GMP+L4+INC+1.png",
                         "/level5/GMP+L4+INC+2.png", 
                      
                        ],
                        [                            
                            "/level6/GMP+L5+INC+1.png",
                            "/level6/GMP+L5+INC+2.png",
           ...
           <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 w-full overflow-hidden relative">
               ...
               <div className="bg-white dark:bg-gray-800 text-center rounded-xl shadow-2xl p-6 w-80 mx-4 transform transition-all duration-300">
                   <h2 className="text-xl font-bold mb-4 text-blue-600 dark:text-white">
                    Global Motion Detection Assessment
                   </h2>

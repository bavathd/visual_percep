...
const GameScreen: React.FC = () => {
  ...
  const url =
    "https://assetsperception.s3.ap-south-1.amazonaws.com/assets/vads/";
  ...
  useEffect(() => {
    ...
    IncorrectCount.forEach((count) => {
      ...
      for (
        let i = 0;
        i < count && indexPointer < availablePositions.length;
        i++
      ) {
    ...
    const newImages: GameImage[] = Array.from(
      { length: totalImages },
      (_, i) => {
  ...
  useEffect(() => {
    console.log("Count updated:", count, "Correct updated:", correct);
  }, [count, correct]);

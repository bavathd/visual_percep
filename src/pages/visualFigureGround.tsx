...
const baseUrl = "https://visualperceptiondomain.s3.ap-south-1.amazonaws.com/game-assets/vfg"
const flashImage = ["/level1/VFG+TR+S.png",
                    "/level2/VFG+L1+S.png", 
                    "/level3/VFG+L2+S.png", 
                    "/level4/VFG+L3+S.png", 
                    "/level5/VFG+L4+S.png", 
...
const correctImage = [["/level1/VFG+TR+CR+1.png", "/level1/VFG+TR+CR+2.png"],
                      ["/level2/VFG+L1+CR+1.png", "/level2/VFG+L1+CR+2.png"],
                      ["/level3/VFG+L2+CR+1.png","/level3/VFG+L2+CR+2.png","/level3/VFG+L2+CR+3.png"], 
                      ["/level4/VFG+L3+CR.png"], 
                      ["/level5/VFG+L4+CR.png"], 
                      ["/level6/VFG+L5+CR.png"] 
                    ];

const inCorrectImage = [["/level1/VFG+TR+INC+1.png", "/level1/VFG+TR+INC+2.png", "/level1/VFG+TR+INC+3.png"],
                        ["/level2/VFG+L1+INC+1.png", "/level2/VFG+L1+INC+2.png", "/level2/VFG+L1+INC+3.png"],
                        ["/level3/VFG+L2+INC+1.png","/level3/VFG+L2+INC+2.png", "/level3/VFG+L2+INC+3.png"], 
                        ["/level4/VFG+L3+INC+1.png","/level4/VFG+L3+INC+2.png", "/level4/VFG+L3+INC+3.png"],
                        ["/level5/VFG+L4+INC+1.png","/level5/VFG+L4+INC+2.png", "/level5/VFG+L4+INC+3.png"],
                        ["/level6/VFG+L5+INC+1.png","/level6/VFG+L5+INC+2.png","/level6/VFG+L5+INC+3.png"],
                        ];
           ...
           <div className="flex-1 bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 w-full overflow-hidden relative">
               {showFlash && (
                   ...
                   <img
                       ...
                       alt="Flash"
                       className="max-w-[50%] h-auto object-contain rounded shadow-xl"
                   />
                   </div>
               )}
   
               {/* Option Images */}
                   <div className="grid grid-cols-4 md:grid-cols-4 gap-4 w-full mt-[10%] justify-between">
...
export default VisualFigureGround;

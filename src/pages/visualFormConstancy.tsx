...
const baseUrl =
  "https://assetsperception.s3.ap-south-1.amazonaws.com/assets/fc";

const flashImage = [
  "/level1/objects/FC+TR+S.png",
  "/level1/shapes/FC+TR+S.png",
  "/level2/objects/FC+L1+S.png",
  "/level2/shapes/FC+L1+S.png",
  "/level3/objects/FC+L2+S.png",
  "/level3/shapes/FC+L2+S.png",
  "/level4/objects/FC+L3+S.png",
  "/level4/shapes/FC+L3+S.png",
  "/level5/objects/FC+L4+S.png",
  "/level5/shapes/FC+L4+S.png",
  "/level6/objects/FC+L5+S.png",
  "/level6/shapes/FC+L5+S.png",
];

const correctImage = [
  "/level1/objects/FC+TR+CR.png",
  "/level1/shapes/FC+TR+CR.png",
  "/level2/objects/FC+L1+CR.png",
  "/level2/shapes/FC+L1+CR.png",
  "/level3/objects/FC+L2+CR.png",
  "/level3/shapes/FC+L2+CR.png",
  "/level4/objects/FC+L3+CR.png",
  "/level4/shapes/FC+L3+CR.png",
  "/level5/objects/FC+L4+CR.png",
  "/level5/shapes/FC+L4+CR.png",
  "/level6/objects/FC+L5+CR.png",
  "/level6/shapes/FC+L5+CR.png",
];
...
const inCorrectImage = [
  [
    // Level 1
    [
      "/level1/objects/FC+TR+INC+1.png",
      "/level1/objects/FC+TR+INC+2.png",
      "/level1/objects/FC+TR+INC+3.png",
    ],
    [
      "/level1/shapes/FC+TR+INC+1.png",
      "/level1/shapes/FC+TR+INC+2.png",
      "/level1/shapes/FC+TR+INC+3.png",
    ],
  ],
  [
    // Level 2
    [
      "/level2/objects/FC+L1+INC+1.png",
      "/level2/objects/FC+L1+INC+2.png",
      "/level2/objects/FC+L1+INC+3.png",
    ],
    [
      "/level2/shapes/FC+L1+INC+1.png",
      "/level2/shapes/FC+L1+INC+2.png",
      "/level2/shapes/FC+L1+INC+3.png",
    ],
  ],
  [
    // Level 3
    [
      "/level3/objects/FC+L2+INC+1.png",
      "/level3/objects/FC+L2+INC+2.png",
      "/level3/objects/FC+L2+INC+3.png",
    ],
    [
      "/level3/shapes/FC+L2+INC+1.png",
      "/level3/shapes/FC+L2+INC+2.png",
      "/level3/shapes/FC+L2+INC+3.png",
    ],
  ],
  [
    // Level 4
    [
      "/level4/objects/FC+L3+INC+1.png",
      "/level4/objects/FC+L3+INC+2.png",
      "/level4/objects/FC+L3+INC+3.png",
    ],
    [
      "/level4/shapes/FC+L3+INC+1.png",
      "/level4/shapes/FC+L3+INC+2.png",
      "/level4/shapes/FC+L3+INC+3.png",
    ],
  ],
  [
    // Level 5
    [
      "/level5/objects/FC+L4+INC+1.png",
      "/level5/objects/FC+L4+INC+2.png",
      "/level5/objects/FC+L4+INC+3.png",
    ],
    [
      "/level5/shapes/FC+L4+INC+1.png",
      "/level5/shapes/FC+L4+INC+2.png",
      "/level5/shapes/FC+L4+INC+3.png",
    ],
  ],
  [
    // Level 6
    [
      "/level6/objects/FC+L5+INC+1.png",
      "/level6/objects/FC+L5+INC+2.png",
      "/level6/objects/FC+L5+INC+3.png",
    ],
    [
      "/level6/shapes/FC+L5+INC+1.png",
      "/level6/shapes/FC+L5+INC+2.png",
      "/level6/shapes/FC+L5+INC+3.png",
    ],
  ],
];

const FormConstancy: React.FC = () => {
  ...
  const handleClick = (id: string) => {
    ...
    if (level >= 2) {
      saveScore("sunny", "vfc", level + 1 - 2, correct, durationMs);
    }
    nextLevel();
  };
